...
export default function App() {
  ...
  return (
    <div className="font-sans bg-slate-50 min-h-screen">
      ...
      {/* ===== HERO ===== */}
      <section id="hero" className="relative md:min-h-screen flex items-center overflow-hidden" style={{background: 'linear-gradient(135deg, #0f172a 0%, #0c2340 50%, #0f172a 100%)'}}>
        ...
        <div className="relative max-w-6xl mx-auto px-4 pt-14 pb-1 md:pt-32 md:pb-20 grid md:grid-cols-2 gap-1 md:gap-12 items-center w-full">
          <div>
            {/* Badge */}
            <div className="inline-flex items-center gap-1.5 bg-blue-500/10 border border-blue-500/30 rounded-full px-2 py-0.5 mb-1 md:mb-6">
              <span className="text-blue-400 text-[9px] md:text-xs font-semibold tracking-widest uppercase">Barasat's Top-Rated Chest Specialist</span>
            </div>

            <h1 className="text-lg sm:text-4xl md:text-5xl xl:text-6xl font-extrabold text-white leading-tight mb-1 md:mb-5">
              Breathe Easy,<br/>
              <span className="bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">Live Fully.</span>
            </h1>

            <p className="text-slate-300 text-[10px] leading-snug sm:text-base md:text-lg mb-1.5 md:mb-6 md:leading-relaxed">
              Expert care for Asthma, COPD, Allergies, and respiratory conditions. Providing advanced diagnostic and therapeutic pulmonology services to help you take control of your lung health.
            </p>
            ...
            <div className="flex flex-wrap gap-1.5 mb-1.5 md:mb-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-500 text-white font-bold px-2.5 py-1.5 md:px-6 md:py-3 rounded-full text-[10px] md:text-base transition-all duration-200 shadow-lg hover:shadow-blue-500/40 hover:-translate-y-0.5"
              >
                📅 Book Appointment
              </a>
              <a
          ...
          <div className="flex justify-start md:justify-end">
            <div className="relative">
              <div className="w-full max-w-[150px] sm:max-w-xs h-[160px] sm:h-[380px] md:w-80 md:h-[460px] rounded-2xl overflow-hidden border-2 border-blue-500/30 shadow-2xl flex flex-col justify-end relative md:mx-0" style={{background: `linear-gradient(180deg, rgba(15,23,42,0) 40%, rgba(15,23,42,0.95) 90%), url(${doctorImg})`, backgroundSize: 'cover', backgroundPosition: 'center', boxShadow: '0 25px 80px rgba(59,130,246,0.3)'}}>
                <div className="p-2 sm:p-6 relative z-10 text-left">
                  <p className="text-white font-extrabold text-sm sm:text-xl">{DOCTOR.name}</p>
                  <p className="text-blue-400 text-[9px] sm:text-sm font-semibold mb-0.5">{DOCTOR.specialty}</p>
