          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-2 md:mb-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 bg-sky-600 hover:bg-sky-500 text-white font-bold px-3 py-2 md:px-6 md:py-3 rounded-full text-xs md:text-base transition-all duration-200 shadow-lg hover:shadow-sky-500/40 hover:-translate-y-0.5"
              >
                📅 Book Appointment
              </a>
              <a
