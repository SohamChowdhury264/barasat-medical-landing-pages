...
export default function App() {
  ...
  return (
    <div className="font-sans bg-slate-50 min-h-screen">
      ...
      {/* ===== HERO ===== */}
      <section id="hero" className="relative md:min-h-[600px] flex items-center overflow-hidden" style={{background: 'linear-gradient(135deg, #0f172a 0%, #0c2340 50%, #0f172a 100%)'}}>
